...
[Behavioral Contracts on S7](s7-interfaces-and-traits.html) vignette defines one
`VectorLike` law suite, runs it against two implementations, and finds a faulty
slice method that satisfies the interface. This vignette explains the generator
and runner machinery used by that example.
...
The table describes the current development version, without claiming API or
seed compatibility with Hedgehog.
