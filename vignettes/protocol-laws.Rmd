...
permutations without replacement, and repeated selections. Missing values, names, and negative indices are
...
replacement remains a composition of `gen_vector()` and `gen_element()`.
