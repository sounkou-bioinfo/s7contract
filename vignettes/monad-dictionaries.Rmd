...
[vector law suite](protocol-laws.html) shows how to assemble generative laws
...
Here the dictionary is an ordinary R object with function-valued properties.
See the [Haskell report](https://www.haskell.org/onlinereport/haskell2010/haskellch6.html)
