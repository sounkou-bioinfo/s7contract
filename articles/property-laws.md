...
| Selection domains | [`gen_sample()`](https://sounkou-bioinfo.github.io/s7contract/reference/gen_sample.md) preserves sample cardinality and distinct source positions; [`gen_subsequence()`](https://sounkou-bioinfo.github.io/s7contract/reference/gen_sample.md) preserves source order. See the [vector laws](https://sounkou-bioinfo.github.io/s7contract/articles/protocol-laws.md). |
| Strings and calendar dates | Composed recipes exercise [UTF-8 store keys](https://sounkou-bioinfo.github.io/s7contract/articles/stateful-protocols.md) and [whole-day intervals](https://sounkou-bioinfo.github.io/s7contract/articles/calendar-intervals.md). |
