...
Structural interfaces and explicit traits address the need described in
the [S7 traits discussion](https://github.com/RConsortium/S7/issues/34):
checking method contracts around existing generics. [Go
interfaces](https://go.dev/ref/spec#Interface_types) inform the
structural approach; [Rust
